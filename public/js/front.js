...
var render = function () {
  ...
  return _c("header", {}, [
    _c("ul", { staticClass: "flex gap-3 items-center" }, [
      _c(
        "li",
        [
...
var render = function () {
  ...
  return _c(
    ...
    {
      class: [
        _vm.pages.current === _vm.n ? "bg-blue-400 text-white" : "",
...
var render = function () {
  ...
  return _c(
    ...
    [
      _c("app-header", {
        staticClass: "bg-stone-500 fixed h-16 top-0 inset-x-0",
      }),
      _vm._v(" "),
      _c("router-view", { staticClass: "py-16" }),
      _vm._v(" "),
      _c("app-header", {
        staticClass: "bg-stone-500 fixed h-16 bottom-0 inset-x-0",
      }),
    ],
    1
  )
